import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@atleta-chain/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@atleta-chain/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
