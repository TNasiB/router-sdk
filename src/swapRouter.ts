...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@atleta-chain/sdk-core'
import { abi } from '@atleta-chain/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@atleta-chain/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
