import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@atleta-chain/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@atleta-chain/v2-sdk'
